...
public:
    ...
    Iceman* CreateIceman(int &m,int &life,int &numId,int &color);
    Dragon* CreateDragon(int &m,int &life,int &numId,int &color);
    Lion* CreateLion(int &m,int &life,int &numId,int &color);
    Ninja* CreateNinja(int &m,int &life,int &numId,int &color);
    Wolf* CreateWolf(int &m,int &life,int &numId,int &color);
...
public:
    ...
    { }
    void CreateWarrior(vector<int> &warriorLife,std::unique_ptr<vector<Warrior*>> &);//制造武士
    /* void print(); */
    int getNumId(){
        return _numId;
    }
